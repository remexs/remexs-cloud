...
public class GenUtils {
    ...
    public static void main(String[] args) {
        ...
        //strategy.setInclude(new String[] { "re_user" }); // 需要生成的表
       // strategy.setInclude(new String[] { "re_table","re_table_column"}); // 需要生成的表
        // 排除生成的表
...
//    	});
        ...
        pc.setParent(null);
        pc.setEntity("com.remexs."+module+".entity");
        pc.setMapper("com.remexs."+module+".dao");
        pc.setXml("com.remexs."+module+".dao.mapper");
        pc.setService("com.remexs."+module+".service");        
        pc.setServiceImpl("com.remexs."+module+".service.impl");    
