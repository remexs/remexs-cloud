...
public class TypeUtils {
	...
	public static Object convert(Object obj, String type, String format) throws ServiceException{
		...
		if (obj instanceof String) {
			...
			if ("Double".equals(type) || "java.lang.Double".equals(type))
				try {
					...
					throw new ServiceException(ErrCode.CONVER_ERROR.getCode(), "Could not convert " + str + " to " + type + ". ", e);
				}
			...
			if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type)) {
				...
				throw new ServiceException(ErrCode.CONVER_ERROR.getCode(), "Conversion from " + fromType + " to " + type + " not currently supported");
			}
		}
		...
		if ("String".equals(type) || "java.lang.String".equals(type))
			...
			throw new ServiceException(ErrCode.CONVER_ERROR.getCode(), "Conversion from " + obj.getClass().getName() + " to " + type + " not currently supported");
	}
	...
	public static Boolean convert2SBoolean(Object obj) throws ServiceException {
		return (Boolean) convert(obj, "Boolean", null);
	}

	public static Integer convert2Integer(Object obj) throws ServiceException {
		return (Integer) convert(obj, "Integer", null);
	}

	public static String convert2String(Object obj) throws ServiceException {
		return (String) convert(obj, "String", null);
	}

	public static String convert2String(Object obj, String defaultValue) throws ServiceException {
	...
	public static Long convert2Long(Object obj) throws ServiceException {
		return (Long) convert(obj, "Long", null);
	}

	public static Double convert2Double(Object obj) throws ServiceException {
		return (Double) convert(obj, "Double", null);
	}

	public static BigDecimal convert2BigDecimal(Object obj, int scale) throws ServiceException {
		return ((BigDecimal) convert(obj, "BigDecimal", null)).setScale(scale, 5);
	}

	public static Date convert2SqlDate(Object obj, String format) throws ServiceException {
		return (Date) convert(obj, "Date", format);
	}

	public static Timestamp convert2Timestamp(Object obj, String format) throws ServiceException {
